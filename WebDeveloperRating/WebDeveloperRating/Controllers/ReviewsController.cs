...
namespace WebDeveloperRating.Controllers
{
    ...
    public class ReviewsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Reviews.Include(r => r.WebDeveloper).Include(r => r.User);
        ...
        // GET: Reviews/Create
        public IActionResult Create(string WebDeveloperId)
        {
            CreateReviewViewModel model = new CreateReviewViewModel();
            model.WebDeveloperId = WebDeveloperId;
            return View(model);
        }
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            ViewData["WebDeveloperId"] = new SelectList(_context.WebDevelopers, "Id", "Id", review.WebDeveloperId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,UserId,WebDeveloperId,Rating,ReviewText")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
